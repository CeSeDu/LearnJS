...
val6 = `my name is ${fullName2}I\'m${2023-yearOfBirt6>=18?'over 18':'under 18'}years old and I live in${city}`;

console.log(val6);

console.clear();

var sentence = 'Set a conditional breakpoint quicker using the Control / Command + click keyboard shortcut in the Sources panel.';
var url =  'The debugger will automatically ignore content scripts injected by extensions.şöüışç';
